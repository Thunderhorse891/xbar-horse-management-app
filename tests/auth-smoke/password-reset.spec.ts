...
const RECOVERY_EMAIL = 'owner@xbar.test';
...
const RECOVERY_KEY = 'xbar-password-recovery-for';
 ...
 */
function sessionLink(type: 'recovery' | 'signin') {
...
const recoveryLink = () => sessionLink('recovery');
 ...
 */
async function stubGoTrueUser(page: Page, onUpdate?: (route: Route) => Promise<void>) {
